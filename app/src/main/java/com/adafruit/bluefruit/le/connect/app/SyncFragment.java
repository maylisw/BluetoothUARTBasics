...
public class SyncFragment extends Fragment implements UartPacketManagerBase.Listener{
    ...
    //UartModeFragment.newInstance(peripheralIdentifier);
    private View rootview;
    private TextView textView;
    private Context context;
    private UartPacketManagerBase mUartData;
    private UartBaseFragment.TimestampItemAdapter mBufferItemAdapter;
    ...
    public void send() {
        ...
        /*uartData.sendAndWaitReply(blePeripheralUart, data.getBytes(), null, 60000, new BlePeripheral.CaptureReadCompletionHandler() {
            @Override
            public void read(int status, @Nullable byte[] value) {
                Log.d(TAG, "read: "+status);
            }
        });*/
